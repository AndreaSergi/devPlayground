...
export function TrisBoardComputer() {
  ...
  const [isComputerTurn, setIsComputerTurn] = useState(false); // Aggiunto stato per indicare il turno del computer
  ...
  function handleCellClick(row, col) {
    if (!board[row][col] && !winner && !isComputerTurn) {
